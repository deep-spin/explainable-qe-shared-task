    ...
    def forward(self,
        ...
        if return_hidden_states:
            if return_attentions:
                return mt_score, output.attentions, output.hidden_states + (hidden_states,)
            return mt_score, output.hidden_states + (hidden_states,)
        if return_attentions:
            return mt_score, output.attentions
        return mt_score
